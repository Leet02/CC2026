...
#include <signal.h>
#include <geometry_msgs/TwistStamped.h> // 添加这一行
...
int main(int argc, char *argv[])
{
    ...
    ros::Subscriber cmd_sub =
        nh.subscribe<quadrotor_msgs::PositionCommand>("/drone_0_planning/pos_cmd",
                                                      100,
    ...
    fsm.cmd_vel_pub = nh.advertise<geometry_msgs::TwistStamped>("mavros/setpoint_velocity/cmd_vel", 10);
